    ...
    <Container>
          ...
          <div className="col-right col-xs-12 col-md-6 col-lg-6 p-3">
            ...
            <div className="sub-col-container">
              ...
              <p className="col-12 body3">
                Nos toma entre 48 y 72 horas en despachar tu pedido a la empresa
                de correo.
                <br />
            ...
            <div className="sub-col-container">
              ...
              <p className="body3">
                ...
                envíos se te entregara un numero de guía para que puedas hacerle
                seguimiento a tu pedido y puedas estar pendiente de su llegada.
              </p>
            </div>
            <div className="sub-col-container">
              <div className="sub-col-header col-12">
              ...
              <p className="body3">
                No realizamos pedidos expres ya que dependemos de los tiempos de
                entrega de las compañía.
              </p>
            </div>
            <div className="sub-col-container">
              <p className="body3">
      ...
      <div className="test-circle">
        <div className="circle-container">
          ...
          <img
            className="circle-payment-img ajustawidthtemp"
            src={circlepaymentimg3}
          ></img>
        </div>
      </div>
    </Container>
